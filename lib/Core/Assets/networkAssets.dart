class AppNetwork {
  ...
  static String MovieDetails(String movieId) {
    return "movie_details.json?movie_id=$movieId&with_images=true&with_cast=true";
  }
  ...
  static String MovieSuggestions(int movieId) {
    return "movie_suggestions.json?movie_id=$movieId";
  }
